      ...
      <div class="col-lg-12">
        ...
        <form method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input class="form-control"  placeholder="Enter Post Title" name="title">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Enter Content . . . . . ." name="post_content"></textarea>
          </div>
            <div class="form-group">
              <label for="exampleFormControlInput1" style="color: black">Post Summery</label>
              <input class="form-control"  placeholder="Enter Post Title" name="post_summery">
            </div>
            <div class="form-group">
              <label for="exampleFormControlTextarea1" style="color: black">Post Content 2</label>
              <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Enter Content . . . . . ." name="post_content2"></textarea>
            </div>
            <div class="form-group">
              <label for="exampleFormControlInput1" style="color: black">Post Search</label>
              <input class="form-control"  placeholder="Type Search Keyword" name="post_search"> </div>
              <div class="form-group">
